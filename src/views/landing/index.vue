    ...
    <v-main>
      <section class="preview mb-15">
        <v-row>
          <v-col cols="6">
            <h2>
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quas eos quia aut officiis
              ut, voluptatem molestiae quasi qui a, sequi autem dicta atque dolorum sit inventore id
      ...
      <section class="search-neighboor mb-15">
        ...
        <v-row>
          ...
          <v-col cols="6">
            ...
            <p>
              ...
              reiciendis beatae porro itaque nemo iure tenetur incidunt architecto officia vero,
              eligendi ab rem eos ex dicta voluptas corrupti. Earum.
            </p>
        ...
        <v-row>
          <v-col cols="6">
            <h2 class="pb-10">
              В качестве волонтера вы можете указать перечень навыков и ресурсов, которыми вы
              обладаете
            </h2>
            <p>
              Поделитесь своими навыками и ресурсами, которые обязаельно могут быть полезны
              нуждающимся людям по близости
            </p>
          </v-col>
          <v-col cols="6">
            <v-chip v-for="skill in previewInfo.skills" :key="skill" class="ma-2" outlined>
              {{ skill }}
            </v-chip>
          </v-col>
        </v-row>
        <v-row>
          <v-col>
            <h2 class="pb-10">
              В случае если вы изолированный, вам предоставляется возможнсть общать с людьми по
              близости, а также найти волонтера с необходимыми средствами
            </h2>
            <p>
              Если вы не можете выйти на улицу, система позволит общаться с людьми поблизости, у
              которых могут быть навыки или ресурсы, необходимые вам. Система позволяет предоставить
              способ попросить о помощи в вашем районе
            </p>
          </v-col>
        </v-row>
        <!----------------------List of services---------------------->
